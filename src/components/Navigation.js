...
export class Navigation extends Component {
    render(){
        return (
            ...
            <NavLink className = "d-inline p-2 bg-dark text-white" to ="/profile">Profile</NavLink>
            ...
            <NavLink className = "d-inline p-2 bg-dark text-white" to ="/assignments">ProfAssignments</NavLink>
            </Nav> 
            </Navbar.Collapse>
            <Nav> </Nav>
            </Navbar>
